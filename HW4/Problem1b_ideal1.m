...
row = 759; col =620; BytesPerPixel = 3;
fileID = fopen('Test_ideal1.raw');
...
for i=1:max(max(L))
crop_new = dilation(crop{i},3);
crop_1 = logical(crop_new);
...
content_test1 = [77; 10; 7; 14; 11; 15; 16; 12; 0; 12; 15; 17; 13; 77];
 
feature_vector_test1 = [content_test1,area,perimeter,euler4,euler8,euler_matlab1,euler_matlab2,...
    circularity,aspect_ratio,M00,M10,M01,M_hu_sum,xk_centroid,yk_centroid,sc_vertical,sc_horizontal,...
    sc];
T_test1 = array2table(feature_vector_test1, ...
