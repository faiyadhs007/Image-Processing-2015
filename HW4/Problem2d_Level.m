...
Img = imread('brian.bmp'); % real miscroscope image of cells
Img=double(Img(:,:,1));
%% parameter setting
timestep=4;  % time step
mu=0.2/timestep;  % coefficient of the distance regularization term R(phi)
iter_inner=50;
iter_outer=27;
lambda=5; % coefficient of the weighted length term L(phi)
%alfa=1.6;  % coefficient of the weighted area term A(phi)
alfa = 1.47;
epsilon=1.5; % papramater that specifies the width of the DiracDelta function

sigma=4.8;     % scale parameter in Gaussian kernel
...
%brain 
initialLSF(115:300,200:525)=-c0; 
% initialLSF(117:357,151:512)=-c0; 
%blood_cells
% initialLSF(10:660,10:820)=-c0; 
