...
Img = imread('coronary.bmp'); % real miscroscope image of cells
Img=double(Img(:,:,1));
%% parameter setting
...
alfa=1.68;  % coefficient of the weighted area term A(phi)
epsilon=1.5; % papramater that specifies the width of the DiracDelta function

sigma=1.67;     % scale parameter in Gaussian kernel
...
%corornary
initialLSF(10:430,10:470)=-c0; 
%brain 
%initialLSF(115:350,150:525)=-c0; 
%blood_cells
