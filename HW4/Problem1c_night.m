...
row = 360; col =267; BytesPerPixel = 3;
fileID = fopen('Test_night.raw');
[Original_img,Red2,Green2,Blue2] = readImage(fileID, row,col, BytesPerPixel);

%% Segmentation of symbols

% Pre-processing the image
RedEq= histeq(Red2);GreenEq= histeq(Green2);BlueEq= histeq(Blue2);
Ieq = cat(3,RedEq,GreenEq,BlueEq);

bw_image  = rgb2gray(Ieq);
...
content_test3 = [77; 77; 77; 77; 77; 77; 77; 77; 10; 1; 14; 11; 9; 15; ...
    16; 12; 12; 15; 5; 17; 13; 77; 77];

feature_vector_test3 = [content_test3,area,perimeter,euler4,euler8,euler_matlab1,euler_matlab2,...
    circularity,aspect_ratio,M00,M10,M01,M_hu_sum,xk_centroid,yk_centroid,sc_vertical,sc_horizontal,...
    sc];
T_test3 = array2table(feature_vector_test3, ...
...
T_test1 = sortrows(T_test3,'Content','ascend');

fprintf(' Note: For this problem: \n segment 1 is 1; segment 2 is 5; segment 9 is S;\n segment 4 is S; segment 5 is P; segment 6 is E; \n segment 7 is E; segment 8 is D; segment 9 is L;\n segment 10 is I; segment 11 is I; segment 12 is M; \n segment 13 is T;segment 14-23 is others.\n Please check from the segmented images\n');
disp('------------------------------------------------------------------');
