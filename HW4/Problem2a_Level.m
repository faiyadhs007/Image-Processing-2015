...
Img = imread('spine.bmp'); % real miscroscope image of cells
Img=double(Img(:,:,1));
%% parameter setting
...
alfa=1.67;  % coefficient of the weighted area term A(phi)
epsilon=1.5; % papramater that specifies the width of the DiracDelta function

sigma=1.87;     % scale parameter in Gaussian kernel
